...
<body>
			...
			<div class="offset-md-2 col-md-8">
				<div class="card">
					<div class="card-body">
						...
						<br>
						<h1 class="orderMsg">Order Placed</h1>
						<hr>
						<b><div>Your Transaction id is <span class="red">#{{$payment_id}}</span></div></b>
						<hr>
						<div>
							<!-- <small>You'll receive an email confirmation shortly on your associated email</small> -->
							<small>Now you can access purchased package</small>
						</div>
						<div class="container">
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-5">
									<ul align="left">
										...
										<li>Secure Authentication Unsuccessful</li>
									</ul>
								</div>
	...
	<script type="text/javascript">
		...
		function ClearAllCartTable() {
					db.cartItems.clear();
					console.log("Deleting all item");
		}
